...
export const Hero: React.FC<HeroProps> = ({ lang, currency }) => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-20 px-4 overflow-hidden bg-nexora-deep">
      ...
      <div className="max-w-[1600px] mx-auto text-center relative z-10 flex flex-col items-center">
        ...
        <div className="flex justify-center mb-8 reveal">
          <div className="inline-flex items-center gap-4 px-8 py-2 bg-[#0a1428]/90 border border-white/10 rounded-full backdrop-blur-xl">
        ...
        <div className="flex justify-center mb-16 reveal" style={{ transitionDelay: '50ms' }}>
          <div className="px-10 py-3 rounded-full border border-blue-500/20 bg-blue-600/10 flex items-center gap-4">
            <div className="w-2 h-2 rounded-full bg-blue-500 shadow-[0_0_10px_#3b82f6]"></div>
            <span className="text-blue-400 text-[11px] md:text-sm font-black uppercase tracking-[0.4em]">
        ...
        <div className="mb-14 reveal" style={{ transitionDelay: '100ms' }}>
          <span className="text-huge text-white">
            {lang === 'ES' ? 'ESTRENAR TU' : 'LAUNCH YOUR'}
          </span>
        ...
        <div className="flex flex-col items-center gap-10 reveal" style={{ transitionDelay: '150ms' }}>
          
          {/* Valor Real con Strike Neón */}
          <div className="luxury-strike">
            <span className="text-slate-500 text-3xl md:text-[4.5rem] font-black italic tracking-tighter opacity-70 uppercase">
          ...
          <div className="flex flex-col items-center">
            {/* Texto Intermedio */}
            <p className="text-3xl md:text-[3.5rem] text-white font-light tracking-tight mb-6">
